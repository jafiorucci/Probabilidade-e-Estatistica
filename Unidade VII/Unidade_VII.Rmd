...
- Considere duas amostras independentes obtidas de duas populações:
  ...
  - $X_{1},\ldots,X_{n_1}$ a.a. de $X$ em que $\mu_1 = E[X]$ e $\sigma_1^2 = Var[X]$ (desconhecida);

  - $Y_{1},\ldots,Y_{n_2}$ a.a. de $Y$ em que $\mu_2 = E[Y]$ e $\sigma_2^2 = Var[Y]$ (desconhecida);
...
\nu=
\frac{(a+b)^2}
{\dfrac{a^2}{n_1-1}+\dfrac{b^2}{n_2-1}},
$$
...
- Com isto, a execução do teste ocorre da mesma forma como vimos para o caso com apenas uma população:
  ...
  1) Escolhe o nível de significância $\alpha$;
